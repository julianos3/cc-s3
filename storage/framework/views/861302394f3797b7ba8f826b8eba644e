            ...
            <table width="580"  class="deviceWidth" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#d0d0d0" style="margin:0 auto;">
                <tr>
                    <td valign="middle" align="center" style="padding:10px; color: #FFFFff; font-size: 1.2em;" bgcolor="#55ba5e">
                        <p>Olá <?php echo e($name); ?>, seja <strong>muito bem vindo</strong> ao Central Condo!</p>
                        <p>
            ...
            <table width="580"  class="deviceWidth" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#d0d0d0" style="margin:0 auto;">
                <tr>
                    <td valign="middle" align="center" style="padding:10px; color: #9a9b9f; font-size: 1.2em;" bgcolor="#ffffff">
                        <p>Seus acessos para começar sua interação com o condomínio <?php echo e($nameCondominium); ?> seguem abaixo:</p>
                        <p>
                            E-mail: <?php echo e($email); ?><br />
                            Senha: <?php echo e($password); ?><br />
            ...
            <table width="580" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth" bgcolor="#ffffff" style="margin:0 auto;">
                <tr>
                    <td class="center" style="padding-top:10px">
                        <table width="59%" border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                            <tr>
                                <td style="color: #9a9b9f; font-weight: normal; text-align: left; font-family: Arial; font-size: 1.2em; vertical-align: top; padding: 0px 8px 10px 15px">
                                    <p>
                                        Caso tenha qualquer problema, não<br />
                                        hesite em contratar a nossa equipe<br />
                                        através do chat online ou pelo e-mail<br />
                                        <a style="color: #9a9b9f; text-decoration: none;" href="mailto:suporte@centralcondo.com.br" title="suporte@centralcondo.com.br">suporte@centralcondo.com.br</a>.
                                    </p>
                                </td>
                            </tr>
                            <tr>
