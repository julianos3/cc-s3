...
use CentralCondo\Services\Portal\FinalityService;
...
class FinalityController extends Controller
{
     ...
     */
    public function __construct(FinalityRepository $repository, FinalityValidator $validator, FinalityService $service)
    {
