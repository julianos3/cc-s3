...
@section('content')
        ...
        <div class="page-content">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <a href="{{ route('portal.condominium.unit.create') }}"
                       data-toggle="tooltip"
                            ...
                            <div class="col-md-12">
                                <table class="tablesaw table-striped table-bordered table-hover"
                                    ...
                                    <tr>
                                        ...
                                        <th data-tablesaw-sortable-col data-tablesaw-priority="1">Andar</th>
                                    ...
                                    @foreach($dados  as $row)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('portal.condominium.unit.edit', ['id' => $row->id]) }}"
                                                   title="Editar"
    ...
    <a href="{{ route('portal.condominium.unit.create') }}" title="Cadastrar"
       data-toggle="tooltip"
       data-original-title="Cadastrar"
