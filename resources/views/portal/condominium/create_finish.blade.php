                                        ...
                                        <div class="wizard-pane active" id="config" role="tabpanel">
                                            <form id="formUnit" method="post"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="control-label" for="user_role_condominium">Minha
                                                                relação com este condomínio</label>
                                                            <select class="form-control" name="user_role_condominium"
                                                                    id="user_role_condominium" required="required">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="control-label" for="user_unit_role">Minha
                                                                relação com esta unidade</label>
                                                            <select class="form-control" name="user_unit_role"
                                                                    id="user_unit_role">
                                                                <option value="">Selecione</option>
