...
@section('content')
        ...
        <div class="page-content">
            <div class="panel">
                <div class="panel-body">
                    ...
                    <a href="{{ route('portal.condominium.provider.category.create') }}"
                       data-toggle="tooltip"
                                    ...
                                    @foreach($dados  as $row)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ route('portal.condominium.provider.category.edit', ['id' => $row->id]) }}"
                                                   title="Editar"
                                                ...
                                                <button title="Excluir"
                                                        ...
                                                        data-route="{{ route('portal.condominium.provider.category.destroy', ['id' => $row->id]) }}">
    ...
    <a href="{{ route('portal.condominium.provider.category.create') }}" title="Cadastrar"
       data-toggle="tooltip"
       data-original-title="Cadastrar"
