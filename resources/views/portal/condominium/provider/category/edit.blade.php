    ...
    <div class="page animsition">
        <div class="page-header">
            ...
            <ol class="breadcrumb" data-plugin="breadcrumb">
                ...
                <li><a href="{{ route('portal.condominium.provider.category.index') }}">Categorias</a></li>
                <li class="active">Alterar</li>
            </ol>
            <div class="page-header-actions">
                <a href="{{ route('portal.condominium.provider.category.index') }}"
        ...
        <div class="page-content">
            <div class="panel">
                <div class="panel-body">
                    ...
                    {!! Form::model($dados, ['route'=>['portal.condominium.provider.category.update', $dados->id]]) !!}

                    @include('portal.condominium.provider.category._form')
