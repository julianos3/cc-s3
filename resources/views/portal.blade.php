...
<head>
    ...
    <title>{{ $config['title'] }} | Central Condo</title>
    ...
    <link rel="stylesheet" href="{{ asset('portal/assets/examples/css/structure/breadcrumbs.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('portal/assets/examples/css/forms/masks.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('portal/global/fonts/web-icons/web-icons.css') }}">
...
<script src="{{ asset('portal/global/vendor/jquery-wizard/jquery-wizard.js') }}"></script>
...
<script src="{{ asset('portal/global/js/plugins/responsive-tabs.js') }}"></script>
<script src="{{ asset('portal/global/js/components/tabs.js') }}"></script>
<script src="{{ asset('portal/global/js/components/asbreadcrumbs.js') }}"></script>
<script src="{{ asset('portal/global/js/components/jquery-wizard.js') }}"></script>
<script src="{{ asset('portal/global/js/components/matchheight.js') }}"></script>
<script src="{{ asset('portal/assets/examples/js/forms/wizard.js') }}"></script>
